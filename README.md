...
### [&nbsp;&nbsp;**DOWNLOAD FOR MAC**&nbsp;&nbsp;](https://github.com/IshanVats-6/huddleowl/releases/download/v0.5.0/HuddleOwl-0.5.0-arm64.dmg)

<sub>Apple Silicon, 204 MB&nbsp; · &nbsp;[Intel Mac](https://github.com/IshanVats-6/huddleowl/releases/download/v0.5.0/HuddleOwl-0.5.0.dmg)&nbsp; · &nbsp;[Windows](https://github.com/IshanVats-6/huddleowl/releases/download/v0.5.0/HuddleOwl-0.5.0-win-x64.exe)&nbsp; · &nbsp;[All files and checksums](https://github.com/IshanVats-6/huddleowl/releases/latest)</sub>
...
# Windows
certutil -hashfile HuddleOwl-0.5.0-win-x64.exe SHA256
```
